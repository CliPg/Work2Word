...
declare global {
  interface Window {
    electronAPI: {
      ...
      convertFile: (mdContent: string, format: 'doc' | 'pdf' | 'md', outputPath?: string, formatSettings?: any, sourceFilePath?: string) => Promise<{ success: boolean; path?: string; buffer?: Buffer; error?: string }>;
